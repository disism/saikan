...
func (uc *UserCreate) AddPlaylistIDs(ids ...uint64) *UserCreate {
...
func (uc *UserCreate) AddAlbumIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddAlbumIDs(ids...)
	return uc
}

// AddAlbums adds the "albums" edges to the Album entity.
func (uc *UserCreate) AddAlbums(a ...*Album) *UserCreate {
...
func (uc *UserCreate) AddMusicIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddMusicIDs(ids...)
	return uc
}

// AddMusics adds the "musics" edges to the Music entity.
func (uc *UserCreate) AddMusics(m ...*Music) *UserCreate {
...
func (uc *UserCreate) AddDirIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddDirIDs(ids...)
	return uc
}

// AddDirs adds the "dirs" edges to the Dir entity.
func (uc *UserCreate) AddDirs(d ...*Dir) *UserCreate {
	ids := make([]uint64, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return uc.AddDirIDs(ids...)
}

// AddSafeIDs adds the "saves" edge to the Saved entity by IDs.
func (uc *UserCreate) AddSafeIDs(ids ...uint64) *UserCreate {
	uc.mutation.AddSafeIDs(ids...)
	return uc
}

// AddSaves adds the "saves" edges to the Saved entity.
func (uc *UserCreate) AddSaves(s ...*Saved) *UserCreate {
	ids := make([]uint64, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uc.AddSafeIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.DirsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := uc.mutation.SavesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
