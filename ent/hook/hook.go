...
type MusicFunc func(context.Context, *ent.MusicMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f MusicFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MusicMutation); ok {
		return f(ctx, mv)
	}
...
// The SavedFunc type is an adapter to allow the use of ordinary
// function as Saved mutator.
type SavedFunc func(context.Context, *ent.SavedMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SavedFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SavedMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SavedMutation", m)
}
...
// The VodeoFunc type is an adapter to allow the use of ordinary
// function as Vodeo mutator.
type VodeoFunc func(context.Context, *ent.VodeoMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f VodeoFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.VodeoMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.VodeoMutation", m)
}
