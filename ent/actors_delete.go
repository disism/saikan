...
func (ad *ActorsDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(actors.Table, sqlgraph.NewFieldSpec(actors.FieldID, field.TypeInt))
...
func (ado *ActorsDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{actors.Label}
	default:
		return nil
	}
}
