...
func (cc *CategorysCreate) check() error {
	return nil
}

func (cc *CategorysCreate) sqlSave(ctx context.Context) (*Categorys, error) {
...
func (cc *CategorysCreate) createSpec() (*Categorys, *sqlgraph.CreateSpec) {
	var (
		_node = &Categorys{config: cc.config}
		_spec = sqlgraph.NewCreateSpec(categorys.Table, sqlgraph.NewFieldSpec(categorys.FieldID, field.TypeInt))
	)
	return _node, _spec
}
...
func (ccb *CategorysCreateBulk) Save(ctx context.Context) ([]*Categorys, error) {
	...
	nodes := make([]*Categorys, len(ccb.builders))
	mutators := make([]Mutator, len(ccb.builders))
	for i := range ccb.builders {
		func(i int, root context.Context) {
			builder := ccb.builders[i]
			var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
				mutation, ok := m.(*CategorysMutation)
				if !ok {
