...
func ID(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...uint64) predicate.Artists {
	return predicate.Artists(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...uint64) predicate.Artists {
	return predicate.Artists(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldLT(FieldID, id))
}

// IDLTE applies the LTE predicate on the ID field.
func IDLTE(id uint64) predicate.Artists {
	return predicate.Artists(sql.FieldLTE(FieldID, id))
}

// Name applies equality check predicate on the "name" field. It's identical to NameEQ.
func Name(v string) predicate.Artists {
	return predicate.Artists(sql.FieldEQ(FieldName, v))
}
...
func And(predicates ...predicate.Artists) predicate.Artists {
	return predicate.Artists(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.Artists) predicate.Artists {
	return predicate.Artists(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.Artists) predicate.Artists {
	return predicate.Artists(sql.NotPredicates(p))
}
