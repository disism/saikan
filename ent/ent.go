...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			actors.Table:     actors.ValidColumn,
			albums.Table:     albums.ValidColumn,
			artists.Table:    artists.ValidColumn,
			audiobooks.Table: audiobooks.ValidColumn,
			categorys.Table:  categorys.ValidColumn,
			devices.Table:    devices.ValidColumn,
			directors.Table:  directors.ValidColumn,
			files.Table:      files.ValidColumn,
			images.Table:     images.ValidColumn,
			musics.Table:     musics.ValidColumn,
			oidc.Table:       oidc.ValidColumn,
			playlists.Table:  playlists.ValidColumn,
