...
func (ac *AlbumCreate) SetYear(u uint32) *AlbumCreate {
	ac.mutation.SetYear(u)
	return ac
}

// SetNillableYear sets the "year" field if the given value is not nil.
func (ac *AlbumCreate) SetNillableYear(u *uint32) *AlbumCreate {
	if u != nil {
		ac.SetYear(*u)
	}
	return ac
...
func (ac *AlbumCreate) AddUserIDs(ids ...uint64) *AlbumCreate {
	ac.mutation.AddUserIDs(ids...)
	return ac
}

// AddUsers adds the "users" edges to the User entity.
func (ac *AlbumCreate) AddUsers(u ...*User) *AlbumCreate {
...
func (ac *AlbumCreate) AddArtistIDs(ids ...uint64) *AlbumCreate {
...
func (ac *AlbumCreate) check() error {
	...
	if _, ok := ac.mutation.ImageID(); !ok {
		return &ValidationError{Name: "image", err: errors.New(`ent: missing required edge "Album.image"`)}
	}
	return nil
}
...
func (ac *AlbumCreate) createSpec() (*Album, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(album.Table, sqlgraph.NewFieldSpec(album.FieldID, field.TypeUint64))
	)
