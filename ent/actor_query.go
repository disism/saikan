...
func (aq *ActorQuery) Order(o ...actor.OrderOption) *ActorQuery {
...
func (aq *ActorQuery) All(ctx context.Context) ([]*Actor, error) {
	...
	return withInterceptors[[]*Actor](ctx, aq, qr, aq.inters)
}
...
func (aq *ActorQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (aq *ActorQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, aq, querierCount[*ActorQuery](), aq.inters)
}
...
func (aq *ActorQuery) Clone() *ActorQuery {
	...
	return &ActorQuery{
		config:     aq.config,
		ctx:        aq.ctx.Clone(),
		order:      append([]actor.OrderOption{}, aq.order...),
...
func (aq *ActorQuery) Select(fields ...string) *ActorSelect {
	...
	sbuild := &ActorSelect{ActorQuery: aq}
...
func (aq *ActorQuery) Aggregate(fns ...AggregateFunc) *ActorSelect {
...
func (aq *ActorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(actor.Table, actor.Columns, sqlgraph.NewFieldSpec(actor.FieldID, field.TypeInt))
	_spec.From = aq.sql
...
func (agb *ActorGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ActorQuery, *ActorGroupBy](ctx, agb.build, agb, agb.build.inters, v)
}

func (agb *ActorGroupBy) sqlScan(ctx context.Context, root *ActorQuery, v any) error {
...
func (as *ActorSelect) Aggregate(fns ...AggregateFunc) *ActorSelect {
...
func (as *ActorSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*ActorQuery, *ActorSelect](ctx, as.ActorQuery, as, as.inters, v)
}

func (as *ActorSelect) sqlScan(ctx context.Context, root *ActorQuery, v any) error {
