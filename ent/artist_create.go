...
func (ac *ArtistCreate) SetID(u uint64) *ArtistCreate {
	ac.mutation.SetID(u)
	return ac
}

// AddMusicIDs adds the "musics" edge to the Music entity by IDs.
func (ac *ArtistCreate) AddMusicIDs(ids ...uint64) *ArtistCreate {
	ac.mutation.AddMusicIDs(ids...)
	return ac
}

// AddMusics adds the "musics" edges to the Music entity.
func (ac *ArtistCreate) AddMusics(m ...*Music) *ArtistCreate {
...
func (ac *ArtistCreate) AddAlbumIDs(ids ...uint64) *ArtistCreate {
...
func (ac *ArtistCreate) createSpec() (*Artist, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(artist.Table, sqlgraph.NewFieldSpec(artist.FieldID, field.TypeUint64))
	)
