...
func HasMusicsWith(preds ...predicate.Music) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		step := newMusicsStep()
...
func HasImagesWith(preds ...predicate.Image) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		step := newImagesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasSavesWith(preds ...predicate.Saved) predicate.File {
	return predicate.File(func(s *sql.Selector) {
		step := newSavesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
