...
func Year(v uint32) predicate.Album {
...
func HasImageWith(preds ...predicate.Image) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := newImageStep()
...
func HasMusics() predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasMusicsWith(preds ...predicate.Music) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := newMusicsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasUsersWith(preds ...predicate.User) predicate.Album {
	return predicate.Album(func(s *sql.Selector) {
		step := newUsersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
