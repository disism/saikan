...
func HasMusics() predicate.Artist {
...
func HasMusicsWith(preds ...predicate.Music) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		step := newMusicsStep()
