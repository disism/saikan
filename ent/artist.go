...
func (e ArtistEdges) MusicsOrErr() ([]*Music, error) {
	if e.loadedTypes[0] {
		return e.Musics, nil
	}
...
// QueryMusics queries the "musics" edge of the Artist entity.
func (a *Artist) QueryMusics() *MusicQuery {
	return NewArtistClient(a.config).QueryMusics(a)
}
