...
func Device(v string) predicate.Device {
	return predicate.Device(sql.FieldEQ(FieldDevice, v))
}
...
func DeviceContainsFold(v string) predicate.Device {
	return predicate.Device(sql.FieldContainsFold(FieldDevice, v))
}
