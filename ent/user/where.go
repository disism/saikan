...
func HasMusicsWith(preds ...predicate.Music) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newMusicsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasDirs applies the HasEdge predicate on the "dirs" edge.
func HasDirs() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasDirsWith applies the HasEdge predicate on the "dirs" edge with a given conditions (other predicates).
func HasDirsWith(preds ...predicate.Dir) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newDirsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasSavesWith(preds ...predicate.Saved) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newSavesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
